...
def parse_args():
    ...
    parser.add_argument('patch_path', action='store',
                        help='path to patch files (in unified diff format)')
...
if __name__ == '__main__':
    ...
    print('[+] %d matches given %d patches ... %.1fs' %
          (exact_nmatch, npatch, elapsed_time))
